...
class InputInterfaceCavPhSocket(Input):
    ...
    def store(self, iface):
        ...
        super(InputInterfaceCavPhSocket, self).store(iface)
        self.latency.store(iface.latency)
        self.mode.store(iface.mode)
        self.address.store(iface.address)
        self.port.store(iface.port)
    ...
    def fetch(self):
        """Creates an InterfaceCavPhSocket object.

        Returns:
           An interface object with the appropriate socket given the attributes
           of the InputInterfaceCavPhSocket object.
        """
...
class InputInterfaceCavPh2DSocket(Input):
    ...
    def store(self, iface):
        ...
        super(InputInterfaceCavPh2DSocket, self).store(iface)
        self.latency.store(iface.latency)
        self.mode.store(iface.mode)
        self.address.store(iface.address)
        self.port.store(iface.port)
    ...
    def fetch(self):
        """Creates an InterfaceCavPh2DSocket object.

        Returns:
           An interface object with the appropriate socket given the attributes
           of the InputInterfaceCavPh2DSocket object.
        """
