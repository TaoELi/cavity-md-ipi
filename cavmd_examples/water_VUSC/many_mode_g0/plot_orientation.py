...
def plot_orientation():
    ...
    #paths = ["E0_4e-4", "../../classical/run_NVE/E0_6e-4"]
    colors = ["k--", "c", "r--", "b-."]
    ...
    for i, path in enumerate(paths):
        data = obtain_avg_data(path, pattern="simu_*.xc.xyz.oac1.txt")
    ...
    clp.adjust(savefile="Orientation_multimode.pdf", tight_layout=True, includelegend=lgd)
